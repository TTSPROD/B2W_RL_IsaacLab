...
def main():
    ...
    for name in ('train_b2w_desktop.py','b2w_runtime.py','benchmark_b2w.py','run_flat_baseline.py','replay_reference_b2w.py','check_policy_contract.py','check_stand_b2w.py','flat_evaluation.py','benchmark_parallel4096.py'):
