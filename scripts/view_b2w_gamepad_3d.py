...
from b2w_gamepad import CommandMapper
...
class Viewer(pyglet.window.Window):
    def __init__(self):
        ...
        self.controls_label = pyglet.text.Label(
            "Hold LB: drive | B/release LB: zero | A: reset | Drag: orbit | Wheel: zoom",
        ...
        child_args = [shell, "-NoProfile", "-File", str(ROOT / "scripts/run_local.ps1"),
                      ...
                      "--device", args.device,
                      "--gamepad-index", str(args.gamepad_index),
                      "--max-forward", str(args.max_forward), "--max-lateral", str(args.max_lateral),
                      "--max-yaw", str(args.max_yaw),
