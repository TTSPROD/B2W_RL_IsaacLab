"""Preregistered 120-episode diagnostic subset; unchanged policy acceptance gates."""
...
from physics57_protocol import ROOT, BASE, CONFIG, sha256, save_json
...
def run(terrain,policy_number,variant):
    ...
    model.opt.timestep=plan['dt_s']
    adapt_model(model,variant,reference()['compiled'])
    ...
    save_json(output,{'schema':'physics57_micro_diagnostic','variant':variant,'engine':'MuJoCo',
        ...
        'adapter_sha256':sha256(ROOT/'scripts/physics57_mujoco_model.py'),
