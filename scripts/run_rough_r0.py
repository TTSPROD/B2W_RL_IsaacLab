...
SOURCES = ('run_rough_r0.py', 'smoke_rough_b2w.py', 'train_b2w.py', 'b2w_rough_runtime.py',
           'b2w_rough_terrain.py', 'b2w_runtime.py', 'reference_transfer.py',
           'b2w_yaw_commands.py', 'yaw_command_sampling.py', 'benchmark_b2w.py', 'smoke_b2w.py')
...
def main():
    ...
    try:
        ...
        for label, count, seed, updates, start, warmup in [('train',64,5700,2,0,1), ('resume',64,5700,2,2,1),
            ...
            command = [PYTHON, '-B', '-u', 'scripts/train_b2w.py', '--rough_r0', '--headless', '--device', 'cuda:0',
