...
SOURCES=('train_b2w.py','b2w_runtime.py','b2w_rough_runtime.py','b2w_rough_terrain.py','rough_curriculum.py','rough_tilt_termination.py',
         ...
         'replay_reference_b2w.py','flat_evaluation.py','check_stand_b2w.py','smoke_b2w.py','benchmark_b2w.py',
