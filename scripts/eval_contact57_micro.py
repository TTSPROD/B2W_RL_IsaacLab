"""Preregistered 40-episode source-collision subset; unchanged acceptance gates."""
...
from contact57_model import BASE, CONFIG, GEOMETRY, make_model, controller
...
def run(terrain,policy_number,variant):
    ...
    save_json(output,{'schema':'contact57_micro_diagnostic','variant':variant,'engine':'MuJoCo',
        ...
        'adapter_sha256':sha256(ROOT/'scripts/contact57_model.py'),
