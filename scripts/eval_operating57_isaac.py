"""Frozen 19999 operating-range evaluation; nominal Isaac, no navigation feedback."""
...
from operating57_protocol import POLICIES, SEED_START, SEEDS, cases_for, protocol_manifest
...
from locomotion57_protocol import (
    DT, Telemetry, assess, export_path,
...
try:
    ...
    source_hashes = {name: sha256(root/'scripts'/name) for name in
                     ('locomotion57_protocol.py', 'operating57_protocol.py', 'eval_operating57_isaac.py', 'local_b2w_assets.py')}
    metadata = {
