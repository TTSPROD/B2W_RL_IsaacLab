...
**Актуально на 23 сентября 2026,18:41 МСК:** серверный 4-GPU upstream завершил 20000 updates; новый inverse57 от upstream10000 запущен автономно с лимитом 15 часов. Локальная RTX4080 Laptop используется для оценки/выгрузки; локальные rough/stair эксперименты документированы отдельно. ABI57→16 сохраняется, stair-v4 отложена. RTX4070Ti требует отдельной квалификации. [Статус](TRAINING_STATUS.md), [активный серверный план](results/2026-09-23-inverse57-overnight-plan.md).
