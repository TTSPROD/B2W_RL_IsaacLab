...
**Область документа — параллельная настольная RTX4070Ti-линия.** Её seeds, модели и gates не тождественны ноутбучным или серверным. Общая карта трёх линий: [TRAINING_STATUS](TRAINING_STATUS.md).
