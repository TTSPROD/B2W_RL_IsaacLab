...
**Исторический документ настольной RTX4070Ti-линии**, сохранён из origin/main20002fa при объединении трёх параллельных линий. Текущий общий статус: [TRAINING_STATUS](TRAINING_STATUS.md). Старые ограничения и будущие шаги ниже относятся к датированному настольному плану.
...
Используются отдельная `.venv` и `scripts/smoke_b2w_desktop.py`, `scripts/train_b2w_desktop.py`,
