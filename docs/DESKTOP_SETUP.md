...
.\.venv\Scripts\python.exe scripts\smoke_b2w_desktop.py --headless --num_envs 16 --physics_steps 10000
.\.venv\Scripts\python.exe scripts\train_b2w_desktop.py --headless --num_envs 256 --max_iterations 2 --run_name setup_smoke
```
