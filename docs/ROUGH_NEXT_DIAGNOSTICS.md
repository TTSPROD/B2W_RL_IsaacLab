...
Обучение остановлено. Действующее состояние — [ROUGH_STAIRS_PLAN](ROUGH_STAIRS_PLAN.md).
Диагностика ниже сохраняется как историческое предложение и ещё не выполнена.
Обсуждённый следующий шаг — сравнение замороженных57-input политик с отдельной
коррекцией существующих velocity commands; новый запуск пока не назначен.
