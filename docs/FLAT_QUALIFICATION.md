...
**Историческая серия 45/46/47 завершена и отклонена.** Текущая очередь —
[staged seeds 49/50/51](STAGED_QUALIFICATION.md). Датированные промежуточные
...
текущий шаг — [повторение staged 49/50/51](STAGED_QUALIFICATION.md).
