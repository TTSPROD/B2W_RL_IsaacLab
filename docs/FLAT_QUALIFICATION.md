...
повторный выбор checkpoint и переход к Rough не назначены. Следующий шаг —
разобрать calf-контакты на yaw и vx bias seed 46, затем описать отдельную
гипотезу с заранее заданными изменением, диагностикой и критерием выхода.
